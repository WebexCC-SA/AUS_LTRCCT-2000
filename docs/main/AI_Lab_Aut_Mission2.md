...
3. Click on create <b>New Action</b>. Under 'Add actions', dropdown the arrow next to Create New and chose Fulfilment, type in  ***Create_New_Order***<span class="copy-static" title="Click to copy!" data-copy-text="Create_New_Order"><span class="copy"></span></span> and the Action Description ***Collect order details, delivery address, total and response with the orderNumber once the order is completed.***<span class="copy-static" title="Click to copy!" data-copy-text="Collect order details, delivery address, total and response with the orderNumber once the order is completed."><span class="copy"></span></span>. In the Action score select <b>Slot filling and fulfillment</b>.
    <details>![Profiles](../graphics/Lab1_AI_Agent/2.18_148.gif)</details>
...
Example: ***177 Pacific Hwy North Sydney NSW 2060***<span class="copy-static" title="Click to copy!" data-copy-text="177 Pacific Hwy North Sydney NSW 2060"><span class="copy"></span></span> <br>
Required: <b>Yes</b>
    <details>![Profiles](../graphics/Lab1_AI_Agent/2.19_148.gif)</details>
...
Description: ***Check if the customer needs delivery or not. Even if they want to proceed with order without specifying the delivery details, ask one more time if they need the delivery or not.***<span class="copy-static" title="Click to copy!" data-copy-text="Check if the customer needs delivery or not. Even if they want to proceed with order without specifying the delivery details, ask one more time if they need the delivery or not."><span class="copy"></span></span> <br>
...
Example: ***+61435044347***<span class="copy-static" title="Click to copy!" data-copy-text="3477579861"><span class="copy"></span></span> <br>
Required: <b>Yes</b>
...
Entity Typs: <b>string</b> <br>
Description: ***Collect the flowers and bouquets information that customer orders. Make sure to do correct math. If one rose is 20 dollars and the customer would like buy 9 roses then the price should be 180 dollars. Don't use double quotes (") in the generated responses.Always use the dollar symbol followed by the numeric total in the response.***<span class="copy-static" title="Click to copy!" data-copy-text="Collect the flowers and bouquets information that customer orders. Make sure to do correct math. If one rose is 20 dollars and the customer would like buy 9 roses then the price should be 180 dollars. Don't use double quotes in the generated responses.Always use the dollar symbol followed by the numeric total in the response."><span class="copy"></span></span> <br>
...
Entity Typs: <b>string</b> <br>
Description: ***After the customer inform if they need delivery or not, and confirm that they would like to proceed with completing the order, collect the Total information and assigned it to this slot. Always use the numeric value for the Total.***<span class="copy-static" title="Click to copy!" data-copy-text="After the customer inform if they need delivery or not, and confirm that they would like to proceed with completing the order, collect the Total information and assigned it to this slot.Always use the numeric value for the Total."><span class="copy"></span></span> <br>
...
11. At this point you should see 7 created entities. Please double check it. 
    <details>![Profiles](../graphics/Lab1_AI_Agent/2.61_148.png)</details>
