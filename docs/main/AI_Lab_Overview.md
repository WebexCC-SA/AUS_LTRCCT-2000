...
2. The AI agent will greet the calling customer.
3. You can insturct the agent to introduce herself as a bot. The AI Agent will suggest flowers that suit the occasion.</br>
4. Customers will also be able to design their own bouquets from single flowers.</br>
5. The AI Agent will capture all the mandatory information like shipping info, email address etc.
5. AI Agent will generate the order details and total price based on the information in the knowledge base</br>
6. AI Agent will send the information about the order to the third pary system. </br>
7. Customer will receive email confirmation with the order details. </br>
8. The customer can always request to be transferred to a live agent along with the details of the conversation between the AI agent and the caller.</br>
